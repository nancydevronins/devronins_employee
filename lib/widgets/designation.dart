            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Text(
                      Strings.designation.toUpperCase(),
                      style: const TextStyle(
                          color: Colors.black, fontWeight: FontWeight.bold),
                    ),
                    SubmitBtn(
                      title: Strings.addDesignation,
                      onTap: () {},
                      isEnableIcon: false,
                    )
                  ],
        ...
        () => Padding(
          ...
          child: ListView.separated(
              ...
              itemBuilder: (context, index) {
                print(DesignationController
                    .instance.designations[index].designationName);
                return Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: [
                      Text(DesignationController
                          .instance.designations[index].designationName
                          .toString()),
                      editDeleteAction()
                    ],
              ...
              itemCount: DesignationController.instance.designations.length),
        ),
      );
