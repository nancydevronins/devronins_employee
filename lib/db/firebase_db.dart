...
class FirebaseDb {
  ...
  static Stream<List<TechnologyModel>> technologyStream() {
    return AuthController()
        .fireStore
  ...
  static Stream<List<DesignationModel>> designationStream() {
    return AuthController()
        .fireStore
        ...
        .map((querySnapshot) => querySnapshot.docs
            .map((designation) =>
                DesignationModel.fromDocumentSnapshot(designation))
            .toList());
  }
